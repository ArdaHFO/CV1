...
import { LayoutDashboard, Briefcase, Settings, LogOut, Menu, Crown, Check, Sparkles, ListChecks, History, Bookmark } from 'lucide-react';
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: 'Job Tracker', href: '/tracker', icon: Bookmark },
