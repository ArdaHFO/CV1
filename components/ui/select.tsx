...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-black/60 px-2 py-2 text-[10px] font-black uppercase tracking-widest", className)}
      {...props}
    />
  )
}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-black focus:text-white [&_svg:not([class*='text-'])]:text-black relative flex w-full cursor-default items-center gap-2 py-2 pr-8 pl-2 text-xs font-black uppercase tracking-widest outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("bg-black pointer-events-none -mx-1 my-1 h-px", className)}
      {...props}
    />
  )
}
